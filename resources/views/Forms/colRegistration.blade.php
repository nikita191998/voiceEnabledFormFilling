     ...
     <div class="container">
             ...
             <div class="col-7">
                 ...
                 <form action="{{ route('form') }}" method="POST">
                     ...
                     <div class="form-group">
                         ...
                         <input type="text" class="form-control" id="gender" placeholder="Enter Your Gender (Male/Female)"
                             name="gender">
                     </div>
                     <div class="form-group">
         ...
         <script>
             window.addEventListener('load', () => {
                 ...
                 msg = 'hello '+"{{ Auth::user()->name }}"+"Please click on the mic if you wish to fill the form using voice"
                 speech.lang = "en-IN";
                 speech.text = msg;
                 speech.volume = 100;
                 speech.rate = 1;
